...
RSpec.describe User, type: :model do
  ...
  describe '#recent_posts' do
    ...
    it 'returns all posts if the specified limit is greater than or equal to the total number of posts' do
      post1 = user.posts.create!(title: 'Post 1', text: 'Body 1', comments_counter: 0, likes_counter: 0, created_at: 1.day.ago)
       post2 = user.posts.create!(title: 'Post 2', text: 'Body 2', comments_counter: 0, likes_counter: 0, created_at: 2.days.ago)
       post3 = user.posts.create!(title: 'Post 3', text: 'Body 3', comments_counter: 0, likes_counter: 0, created_at: 3.days.ago)
